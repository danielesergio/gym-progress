...
Se hai bisogno di creare script di calcolo o file di verifica durante l'elaborazione, salvali **esclusivamente** in `scripts/agent-temp/gym-pt-micro-mini-cut/`. Non creare mai file temporanei in altre cartelle.
